      ...
      super(env).tap do |_, headers, _|
        ...
        if ssl?(env)
          ...
          policies += [
            ...
            "connect-src 'self' https: https://api.pusherapp.com wss://ws.pusherapp.com wss://*.firebaseio.com http://localhost:8080 https://curriculum.code.org/ wss://*.code.org wss://javabuilderbeta.dev-code.org wss://javabuilder-darin.dev-code.org",
